...
const Navber = () => {
    ...
    const navLinks = <>
        ...
        <NavLink to="/about" className={({ isActive }) => isActive ? 'border-b-3 border-green-500 text-green-500 font-bold p-2' : 'font-bold p-2'}>ABOUT US</NavLink>
        <NavLink to="/contact" className={({ isActive }) => isActive ? 'border-b-3 border-green-500 text-green-500 font-bold p-2' : 'font-bold p-2'}>CONTACT US</NavLink>

    </>

    return (
        <div className="navbar px-10 bg-green-50 text-black shadow-sm">
