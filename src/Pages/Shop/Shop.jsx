        ...
        <div>
            <div className='px-4 md:px-10 py-10'>
                ...
                <div className='md:hidden mb-4 text-center'>
                    <button className='flex items-center gap-4 px-4 py-2 bg-green-500 text-white rounded-full shadow-md'><FaFilter /> Show FIlters</button>
                </div>

                <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mt-5'>
                    {/* Filters Sidebar */}
                    <aside className={'md:col-span-1 bg-green-50 p-4 rounded-xl shadow md:block'}>
                        {/* Category Filters */}
                        <div className='mb-6'>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <aside className={`md:col-span-1 bg-green-50 p-4 rounded-xl shadow ${showFilters ? 'block' : 'hidden'} md:block`}>
                        ...
                        <div className="mb-6">
                            <h3 className="font-semibold text-green-800 mb-2">Price Range</h3>
                            <input type="range" min="0" max="100" className="w-full text-green-500" />
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                            ...
                            <div className="relative w-full md:w-1/2">
                                <input
                                    ...
                                    className="w-full px-4 py-2 border border-green-300 rounded-full shadow-sm focus:outline-none"
                                />
                                <FaSearch className="absolute right-4 top-3 text-green-500" />
                            </div>

                            {/* Sort By Dropdown */}
                            <select className="border border-green-300 rounded-full px-4 py-2 focus:outline-none">
