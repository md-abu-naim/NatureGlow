        ...
        <div className="bg-green-50 p-4 mt-6 rounded-lg">
            <div className="flex flex-col md:flex-row justify-between items-center pb-10">
                ...
                <div className='flex gap-2 mt-2 lg:mt-0'>
                    ...
                    <span className='bg-green-100 text-green-700 py-1 px-2 shadow rounded text-sm font-medium'>Paid</span>
                    <span className='border border-yellow-300 rounded-full text-yellow-500 px-3 py-1 text-sm font-medium shadow'>In Progrss</span>
                </div>
            </div>
