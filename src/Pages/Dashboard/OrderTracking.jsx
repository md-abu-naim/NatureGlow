...
// export default function OrderStepper({ status = 'in progress' }) {
//     const stepIndex = {
//         'in progress': 0,
//         shipped: 1,
//         delivered: 2,
...
//                 <h3 className="text-lg font-bold text-green-800">Order Details</h3>
//                 <div>
//                     {/* <span className={`px-2 py-1 rounded text-sm font-medium shadow-sm ${product.paymentStatus === 'Paid' ? 'bg-green-100 text-green-700' : product.paymentStatus === 'Unpaid' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
//                                         paid
//                                     </span>
...
//                             fontSize: '14px',
//                         },
//                         '& .MuiStepIcon-root.Mui-active': { color: '#22c55e' }, // green
