...
const UserRoutes = () => {
    return (
        <div>
            ...
            <NavLink to='/address' className={({isActive}) => `flex items-center gap-2 p-2 hover:bg-green-500 rounded transition-colors duration-300 transform ${isActive && 'bg-green-700 text-white hover:text-black'}`}><FaLocationArrow />Address Book</NavLink>
        </div>
    );
};
