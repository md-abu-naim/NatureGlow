...
//     image: "https://i.pravatar.cc/150?img=3" // fallback image
//   };


//   return (
//     <div className="min-h-screen bg-white flex items-center justify-center px-4 py-8">
//       <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-lg p-6 text-center">
//         <img
//           src={user.image}
//           alt="Profile"
//           className="w-28 h-28 mx-auto rounded-full border-4 border-green-500 object-cover"
//         />
//         <h2 className="mt-4 text-2xl font-semibold text-gray-800">{user.name}</h2>
//         <p className="text-sm text-gray-500">User ID: <span className="font-medium">{user.userId}</span></p>

//         <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
//           <button className="bg-green-500 hover:bg-green-600 text-white font-semibold px-5 py-2 rounded-md transition">
//             Update Profile
//           </button>
//           <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-5 py-2 rounded-md transition">
//             Reset Password
//           </button>
//         </div>
//       </div>
