...
const ChangePassword = ({ setOpenPassModal }) => {
    ...
    const { passwordUpdate, reauthencticateUser, user } = useAuth()
    ...
    const handleChangePassword = (e) => {
        ...
        console.log(form, newPassword, confirmPass);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className="bg-green-100 w-full max-w-lg rounded-lg p-6 shadow-lg border border-green-300">
                <h2 className="text-2xl font-bold text-green-800 mb-4 text-center">{isPasswordProvider ? "Change Password" : 'Update Password'}</h2>
