    ...
    return (
        <section className="px-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-7 gap-8">
                {
                    testimonials?.map(t => <div key={t._id} className="flex flex-col justify-between bg-green-50 border border-green-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition duration-300">
                        ...
                        <div className="flex items-center gap-4 mt-auto">
                            <img className="w-12 h-12 rounded-full object-center border-2 border-green-400" src={t.profile} alt="" />
                            <div>
